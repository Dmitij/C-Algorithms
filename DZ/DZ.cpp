...
void HW7()
{
	...
	{
		system("cls");
		cout << "***Домашнее задание 7***\n";
		cout << "1. Написать функцию обхода графа в глубину.\n";
		cout << "2. Написать рекурсивную функцию обхода графа в ширину.\n";
		//cout << "3. ***Разработать базу данных студентов из двух полей “Имя”, “Возраст”, “Табельный номер” в которой использовать все знания, полученные на уроках.\n";
		cout << "ESC - Exit\n";
